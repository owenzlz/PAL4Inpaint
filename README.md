...
The blue contour in the first image indicates the original hole, and the pink contours in each images indicate the 
localized perceptual artifacts region at each iterative fill.
